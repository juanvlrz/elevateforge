...
import { players as initialPlayers, matches, VOTING_START_DATE } from './constants.ts';
import type { Player, ValorantMap } from './types.ts';
...
const VotingSection = lazy(() => import('./components/VotingSection.tsx').then(module => ({ default: module.VotingSection })));
const BracketSection = lazy(() => import('./components/BracketSection.tsx').then(module => ({ default: module.BracketSection })));
const MapVetoSection = lazy(() => import('./components/MapVetoSection.tsx').then(module => ({ default: module.MapVetoSection })));
const StreamSection = lazy(() => import('./components/StreamSection.tsx').then(module => ({ default: module.StreamSection })));
const ScheduleSection = lazy(() => import('./components/ScheduleSection.tsx').then(module => ({ default: module.ScheduleSection })));
